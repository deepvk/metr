...
class PNetLin(nn.Module):
    def __init__(
        ...
        self.shift = torch.autograd.Variable(torch.Tensor([-0.030, -0.088, -0.188]).view(1, 3, 1, 1))
        self.scale = torch.autograd.Variable(torch.Tensor([0.458, 0.448, 0.450]).view(1, 3, 1, 1))
